            ...
            <div className="container">
                <div className="row row-cols-1 row-cols-md-2 gy-4 gy-lg-0 gx-lg-14">
                    <div className="col pe-md-8">
                        <img src={user?.imageSrc} width="300" height="300" className="w-100 h-100" alt="" />
                    </div>
                        ...
                        <div className="pb-lg-10">
                            <ul className="list-unstyled list-style1">
                                <li>
                                    ...
                                    <article>
                                        <span>Phone</span>
                                        <a href="tel:+97165758800" className="text-decoration-none text-primary">+971 6 5758
                                            800</a>
                                    </article>
                                </li>
                                <li>
                                    ...
                                    <article>
                                        ...
                                        <a href="mailto:+stephen@citymarinebrokers.com"
                                            className="text-decoration-none text-primary">stephen@citymarinebrokers.com</a>
                                    </article>
                                </li>
                            </ul>
                        </div>
